...
const BTN_GAP = '8px' // gap between buttons in a cluster
    ...
    <>
      ...
      {!frozen && scheme === 'buttons' && (
        <>
          ...
          <div style={{
            position: 'fixed',
            bottom: `max(calc(env(safe-area-inset-bottom) + 28vh), 4rem)`,
          ...
          <div style={{
            position: 'fixed',
            bottom: `max(calc(env(safe-area-inset-bottom) + 28vh), 5rem)`,
